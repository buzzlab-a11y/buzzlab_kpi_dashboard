// Google Material Design 3 準拠デザイントークン
export const G = {
  // ── Primary (Google Blue) ─────────────────────────
  primary:          '#1a73e8',
  primaryHover:     '#1b66c9',
  ...
  ln:  { main: '#06C755', container: '#e6f4ea', gradient: 'linear-gradient(135deg,#06C755,#2E7D32)' },
  ...
  shadow3: '0 4px 8px 3px rgba(60,64,67,.15),0 1px 3px rgba(60,64,67,.3)',
