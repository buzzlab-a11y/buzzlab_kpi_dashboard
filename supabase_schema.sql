...
insert into monthly_targets (month, channel, acc_count, lists, revenue, sort_order) values
  ...
  ('4月',  'jv',         0, 0,    0,         4),
  -- 5月
  ('5月',  'instagram', 10, 180,  1800000,   5),
  ('5月',  'youtube',    2, 40,   600000,    5),
  ('5月',  'threads',    0, 0,    0,         5),
  ('5月',  'jv',         0, 100,  2000000,   5),
  -- 6月
  ('6月',  'instagram', 15, 540,  5400000,   6),
  ('6月',  'youtube',    3, 160,  2400000,   6),
  ('6月',  'threads',    5, 0,    0,         6),
  ('6月',  'jv',         0, 100,  2000000,   6),
  -- 7月
  ('7月',  'instagram', 20, 1040, 10400000,  7),
  ('7月',  'youtube',    4, 520,  7800000,   7),
  ('7月',  'threads',   10, 180,  900000,    7),
  ('7月',  'jv',         0, 100,  2000000,   7),
  -- 8月
  ('8月',  'instagram', 25, 1540, 15400000,  8),
  ('8月',  'youtube',    5, 920,  13800000,  8),
  ('8月',  'threads',   15, 540,  2700000,   8),
  ('8月',  'jv',         0, 100,  2000000,   8),
  -- 9月
  ('9月',  'instagram', 30, 2040, 20400000,  9),
  ('9月',  'youtube',    6, 1320, 19800000,  9),
  ('9月',  'threads',   20, 1040, 5200000,   9),
  ('9月',  'jv',         0, 100,  2000000,   9),
  -- 10月
  ('10月', 'instagram', 35, 2540, 25400000,  10),
  ('10月', 'youtube',    7, 1720, 25800000,  10),
  ('10月', 'threads',   25, 1540, 7700000,   10),
  ('10月', 'jv',         0, 100,  2000000,   10),
  -- 11月
  ('11月', 'instagram', 40, 3040, 30400000,  11),
  ('11月', 'youtube',    8, 2120, 31800000,  11),
  ('11月', 'threads',   30, 2040, 10200000,  11),
  ('11月', 'jv',         0, 100,  2000000,   11),
  -- 12月
  ('12月', 'instagram', 45, 3540, 35400000,  12),
  ('12月', 'youtube',    9, 2520, 37800000,  12),
  ('12月', 'threads',   35, 2540, 12700000,  12),
  ('12月', 'jv',         0, 100,  2000000,   12);
